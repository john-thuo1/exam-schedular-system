...
from exams.views import (about, CourseListView, CourseCreateView, CourseUpdateView, CourseDeleteView,
                         UnitListView, UnitCreateView, UnitUpdateView, UnitDeleteView,
                         ExamListView, ExamCreateView, ExamUpdateView, ExamDeleteView, home)
